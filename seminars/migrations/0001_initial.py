# Generated by Django 4.2 on 2023-12-14 21:00
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=128, verbose_name="Nombre del semillero"
                    ),
                ),
                (
                    "state",
                    models.CharField(max_length=256, verbose_name="Estado actual"),
                ),
                ("email", models.CharField(max_length=256, verbose_name="E-mail")),
                (
                    "departament",
                    models.CharField(max_length=256, verbose_name="Departamento"),
                ),
                ("faculty", models.CharField(max_length=256, verbose_name="Facultad")),
                (
                    "founded",
                    models.DateField(
                ...
                (
                    "focus",
                    models.TextField(
                        blank=True, max_length=65536, null=True, verbose_name="Enfoque"
                    ),
                ),
                (
                    "ocde",
                    models.CharField(
                        choices=[
                            ...
                            ("ocde_0105", "Ciencias sociales | Derecho | Derecho"),
                            (
                                "ocde_0106",
                            ...
                            ("ocde_0127", "Humanidades | Arte | Artes escénicas "),
                            ("ocde_0128", "Humanidades | Arte | Diseño arquitectónico"),
                            ("ocde_0129", "Humanidades | Arte | Estudios del folklore"),
                            (
                                "ocde_0130",
                                "Humanidades | Arte | Estudios sobre cine, radio y televisión",
                            ),
                            ("ocde_0131", "Humanidades | Arte | Otras artes"),
                            (
                                "ocde_0132",
                ...
                (
                    ...
                    models.TextField(
                        max_length=256,
                        verbose_name="Objetivo de desarrollo sosternible",
                    ),
                ),
                (
                    "knowledge_area",
                    models.CharField(
                        ...
                        max_length=114,
                        verbose_name="Agenda del conocimiento",
                    ),
                ),
                (
                    "discourse",
                    models.TextField(
                        ...
                        max_length=65536,
                        null=True,
                        verbose_name="Pertinencia / Articulación con grupos de investigación",
                    ),
                ),
                (
                    "methodology",
